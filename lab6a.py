...
class Student:
    ...
    def displayStudent(self):
        return 'Student Name: ' + self.name + '\n' + 'Student Number: ' + str(self.number) #prevent error when user enter number
    ...
    def displayGPA(self):
        ...
        if len(self.courses) == 0:
            return 'GPA of student ' + self.name + ' is 0.0' # return 0.0 when no grade is provided
    ...
    def displayCourses(self):
        return [course for course in self.courses if self.courses[course] > 0.0] #return a list of course where the grade is > 0.0
